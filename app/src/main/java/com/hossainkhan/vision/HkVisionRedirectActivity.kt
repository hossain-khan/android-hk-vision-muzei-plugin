...
package com.hossainkhan.vision
...
/**
 * This activity's sole purpose is to redirect users to Muzei App, which is where they should
 * activate Muzei and then select the H.K. Vision as a source.
 *
 ...
 * > every app.
 *
 * Source code reference taken from:
 * https://github.com/romannurik/muzei/blob/master/example-unsplash/src/main/java/com/example/muzei/unsplash/UnsplashRedirectActivity.kt
 */
class HkVisionRedirectActivity : ComponentActivity() {
    companion object {
        private const val TAG = "VisionRedirect"
        private const val MUZEI_PACKAGE_NAME = "net.nurik.roman.muzei"
        private const val MUZEI_PLAY_STORE_LINK = "https://play.google.com/store/apps/details?id=$MUZEI_PACKAGE_NAME"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val intents =
            listOf(
                MuzeiContract.Sources.createChooseProviderIntent(BuildConfig.HK_VISION_MUZEI_PROVIDER_AUTHORITY)
                    to R.string.toast_enable_hk_vision_plugin,
                packageManager.getLaunchIntentForPackage(MUZEI_PACKAGE_NAME)
                    to R.string.toast_enable_hk_vision_source,
