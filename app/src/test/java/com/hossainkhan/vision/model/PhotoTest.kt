...
class PhotoTest {
    ...
    fun `given photo json - parses photo metadata`() {
        assertThat(
            "Title mismatch", "⛰ Mountain Falls", IsEqual(sut.title)
        )
        assertThat(
            "Sub-title mismatch", "f: 4.5, t: 1/100s, l: 28mm, Sony RX-100", IsEqual(sut.subtitle)
        )
        assertThat(
            "Date mismatch", "2017-12-28 13:34:11", IsEqual(sut.date)
        )
        assertThat(
            "Web URL mismatch",
